...
import sidebarBgImage from 'assets/img/sidebar/intech.jpg';
...
const navItems = [
  ...
  { to: '/balance-request', name: 'Request', exact: true, Icon: MdDashboard },
  { to: '/fund-transfer', name: 'Fund Transfer', exact: true, Icon: MdDashboard },
  { to: '/make-payment', name: 'Payment', exact: true, Icon: MdDashboard },
  { to: '/transaction-history', name: 'Transaction History', exact: true, Icon: MdDashboard }
